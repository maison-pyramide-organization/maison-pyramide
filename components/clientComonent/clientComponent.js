  ...
  const [clientList, setClientList] = useState([
    {
      ...
      imgRight: client1,
      imgLeft: client2,
      client_name: "Ahmed Alammary",
      owner_title: "MDLBEAST, Chief Creative Officer",
      description:
        "“Working with MP has been invaluable as an experience.  Always focused on creating winning combinations with flair and strategic thinking within fashion and marketing. Through our work we have formed great bonds and we truly love working with each other and complementing each teams’ excellence.”",
    },
    {
      id: 3,
      name: "EMAAR",
      imgRight: client4,
      imgLeft: client3,
      client_name: "Mostafa el Kady",
      owner_title: "EMAAR Egypt, CEO",
      description:
        "“Each project that we have partnered with Maison Pyramide on, their high standards and understanding of our market has left us feeling very satisfied with their work”",
    },
    // {id:1,name:'UNICEF',imgRight:client3,imgLeft:client4,client_name:'Hussein Aboelross',owner_title:"L'Oréal Egypt, Managing Director",description:'“We have been working with Maison Pyramide for years now, and the team has not only satisfied us with their strategy and digital expertise, but their professionalism and availability has definitely made it a stronger partnership”'},
    {
      ...
      imgRight: client7,
      imgLeft: client8,
      client_name: "Hussein Aboelross",
      owner_title: "L'ORÉAL Egypt, Managing Director",
      description:
        "“We have been working with Maison Pyramide for years now, and the team has not only satisfied us with their strategy and digital expertise, but their professionalism and availability has definitely made it a stronger partnership”",
    },
    ...
    // {id:5,name:'MÔNOT',imgRight:client11,imgLeft:clientImg2,client_name:'Harvey Nicholas',owner_title:'MÔNOT, Creative Director',description:'“Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ac adipiscing viverra dui egestas ut faucibus dictum sit. Fermentum mauris proin sed molestie. In ipsum, scelerisque est adipiscing viverra urna nunc quam.”'},
    {
      ...
      imgRight: client13,
      imgLeft: client12,
      client_name: "Laura Larbalestier",
      owner_title: "Harvey Nichols Group Fashion Director",
      description:
        '“Maison Pyramide are leaders in the discovery of new talent and are unique in their ability to be able to support their brands, not just in the showroom but with innovative launch ideas and events."',
    },
  ]);
      ...
      <section className={clientStyles.client}>
        <Container className={clientStyles.client_container}>
          <div className={clientStyles.text} ref={sectionRef}>
            <h2>
              Hear from our clients <br /> and trusted partners{" "}
            </h2>
            <TransitionGroup>
              {!loadingFlag && (
                <CSSTransition key={3} timeout={3000} classNames={"item"}>
                  <div>
                    <p>{animatedText(clientList[client].description)}</p>
                      ...
                      <Row>
                        ...
                        <Col sm={6} xs={6}>
                          <div className={clientStyles.mobile_img}>
                            ...
                            <Image
                              unoptimized={true}
                              src={clientList[client].imgRight}
                              alt="shoes"
                              height={150}
                              objectFit={"cover"}
                              width={100}
              ...
              <div id="tabs" className={clientStyles.tabs_container}>
                ...
                <ul>
                  {clientList.map((cli, ind) => (
                    <li
                      key={ind}
                      className={client == ind ? clientStyles.active : ""}
                      onClick={() => handleClient(ind)}
                    >
                      {cli.name}
                    </li>
                  ))}
              ...
              <div className={clientStyles.btns}>
                ...
                <div className={`${clientStyles.slider_ctrls} mobile`}>
                  <div
                    ...
                    className={`${clientStyles.slider_ctrl} ${clientStyles.slider_ctrl_left}`}
                  >
                    <span className={clientStyles.chev_left}></span>
                  </div>
                  <div
                    onClick={handleRightClick}
                    className={`${clientStyles.slider_ctrl} ${clientStyles.slider_ctrl_right}`}
                  >
