...
function ClientComponent() {
    ...
    const [clientList, setClientList] = useState([
      {id:0,name:'MDLBEAST',imgRight:client1,imgLeft:client2,client_name:'Ahmed Alammary',owner_title:'MDLBEAST, Chief Creative Officer',description:'“Working with MP has been invaluable as an experience.  Always focused on creating winning combinations with flair and strategic thinking within fashion and marketing. Through our work we have formed great bonds and we truly love working with each other and complementing each teams’ excellence.”'},
      {id:3,name:"EMAAR",imgRight:client4,imgLeft:client3,client_name:'Mostafa el Kady',owner_title:'EMAAR Egypt, CEO',description:'“Each project that we have partnered with Maison Pyramide on, their high standards and understanding of our market has left us feeling very satisfied with their work”'},
