...
import client2 from '../../public/imgs/client1.2.jpeg';
import client3 from '../../public/imgs/client2.1.jpeg';
import client4 from '../../public/imgs/client2.2.jpeg';
import client5 from '../../public/imgs/client3.1.jpeg';
import client6 from '../../public/imgs/client3.2.jpeg';
import client7 from '../../public/imgs/client4.1.jpeg';
import client8 from '../../public/imgs/client4.2.jpeg';
import client9 from '../../public/imgs/client5.1.jpeg';
import client10 from '../../public/imgs/client5.2.jpeg';
import client11 from '../../public/imgs/client6.2.jpeg';
...
function ClientComponent() {
    ...
    const [clientList, setClientList] = useState([
      ...
      // {id:1,name:'UNICEF',imgRight:client3,imgLeft:client4,client_name:'Hussein Aboelross',owner_title:"L'Oreal Egypt, Managing Director",description:'“We have been working with Maison Pyramide for years now, and the team has not only satisfied us with their strategy and digital expertise, but their professionalism and availability has definitely made it a stronger partnership”'},
      {id:2,name:"L'OREAL",imgRight:client7,imgLeft:client8,client_name:'Hussein Aboelross',owner_title:"L'Oreal Egypt, Managing Director",description:'“We have been working with Maison Pyramide for years now, and the team has not only satisfied us with their strategy and digital expertise, but their professionalism and availability has definitely made it a stronger partnership”'},
      // {id:4,name:'SRMG',imgRight:client11,imgLeft:client12,client_name:'Hussein Aboelross',owner_title:"L'Oreal Egypt, Managing Director",description:'“We have been working with Maison Pyramide for years now, and the team has not only satisfied us with their strategy and digital expertise, but their professionalism and availability has definitely made it a stronger partnership”'},
      {id:5,name:'MÔNOT',imgRight:client11,imgLeft:clientImg2,client_name:'Ahmed Alammary',owner_title:'MDLbeast, Creative Director',description:'“Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ac adipiscing viverra dui egestas ut faucibus dictum sit. Fermentum mauris proin sed molestie. In ipsum, scelerisque est adipiscing viverra urna nunc quam.”'},
      {id:2,name:'HARVEY NICHOLAS',imgRight:client13,imgLeft:client12,client_name:'Laura Larbalestier',owner_title:'Harvey Nichols Group Fashion Director',description:'“Maison Pyramide are leaders in discovery of new talent and are unique in their ability to be able to support their brands, not just in the showroom but with innovative launch ideas and events."'},
    ])
