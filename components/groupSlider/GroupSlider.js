...
const _items = [
    ...
    // },
    {
        id:1,
        sections:[
            {id:0,"title":"Culture","desc":"Founded by three creative and ambitious women who are mothers above all, Maison Pyramide fosters a nurturing culture where creativity thrives. Our business succeeds because of positive collaboration, inspiring loyalty from our teams and clients alike We passionately support forward-thinking clients, and we understand what purposeful brands mean for today's consumers. Aesthetics are important, but so are respect, diversity, and quality. Our culture reflects this, by empowering young talent within our family. Our standards are high, and we inspire our teams to work as hard as we do."},
