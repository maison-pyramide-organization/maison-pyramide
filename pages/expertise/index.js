                ...
                <div className={expertiseStyles.title}>
                  <div style={{ overflow: "hidden" }}>
                    <AnimatePresence>
                      ...
                      >
                        INNOVATIVE <br />
                        SOLUTIONS FOR YOUR BUSINESS <br /> TO STRIVE ON A GLOBAL
                        LEVEL
                      </motion.h1>
                    </AnimatePresence>
                  </div>
                  <p>
                    <AnimatePresence>
                      {animatedText(
                        "We elevate fashion, lifestyle, luxury, and media brands by blending intelligent strategy with highly creative execution. Our deep connections with millennial culture help businesses find relevance in today's world. Our five main areas of expertise: Media, Public Affairs, Lifestyle, Retail, and Fashion."
                      )}
                    </AnimatePresence>
                  </p>
                </div>
          ...
          <Container>
            ...
            {_expertise.map((exp, ind) => {
              return ind % 2 == 0 ? (
                <Row
                  key={ind}
                  onClick={() => handleClick(exp.attributes.feature)}
                >
                  <Col md={5}>
                    <Parallax
                      translateY={[isMobile ? 0 : 10, isMobile ? 0 : -1]}
                    >
                      <ParallaxCache />
                      <div className={expertiseStyles.exp_img}>
                        ...
                        <Image
                          src={exp?.attributes?.image?.custom_data?.url}
                          unoptimized={true}
                          layout="responsive"
                          width={100}
                          objectFit={"cover"}
                  ...
                  <Col md={7}>
                    <Parallax
                      translateY={[isMobile ? 0 : 60, isMobile ? 0 : 0]}
                    >
                      <ParallaxCache />
                      <div className={expertiseStyles.text}>
                        ...
                        <pre>{animatedText(exp.attributes?.description)}</pre>
                        <br />
                        <p>
                ...
                <Row
                  key={ind}
                  className={expertiseStyles.reverse_mobile_row}
                  onClick={() => handleClick(exp.attributes.feature)}
                >
                  <Col md={7}>
                    <Parallax
                    ...
                    >
                      <ParallaxCache />
                      <div
                        className={`${expertiseStyles.text} ${expertiseStyles.left_text}`}
                      >
                        <motion.h3
                          className="disktop_only"
                          initial="hidden"
                        ...
                        <p>{animatedText(exp.attributes?.description)}</p>
                        <br />
                        <p>
                          {!isTextExpand[ind] && isMobile ? (
                            <p
