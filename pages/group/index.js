      ...
      {data && (
        <ParallaxProvider>
          <header className={groupStyles.header}>
            ...
            >
              MAISON PYRAMIDE GROUP
            </motion.h1>
            {isMobile != null && (
              <video
                className={groupStyles.header.video}
                unoptimized={true}
                autoPlay
                playsInline
                muted
              ...
              >
                <source
                  src={
                    isMobile
                      ? "https://res.cloudinary.com/dhqpdvngy/video/upload/v1692870421/MP%20Group%20video/MOBILE_LOOPED_chimmh.mp4"
                      : "https://res.cloudinary.com/dhqpdvngy/video/upload/v1692869545/MP%20Group%20video/DESKTOP_LOOPED_ketdh0.mp4"
                  }
                />
              </video>
            )}
  ...
  Dubai design district.</span> */}
                  ...
                  <Col md={4}>
                    <div className={groupStyles.card}>
                      ...
                      <div className={groupStyles.groupDescription}>
                        <span>
                          {animatedText(
                            "Maison Pyramide is the strategic branch of the company supporting the pace of innovation and growth of young and established entities looking to expand and grow."
                          )}
                        </span>
                      </div>
                      <Link href="/services">
                  ...
                  <Col md={4}>
                    <div className={groupStyles.card}>
                      ...
                      <div className={groupStyles.groupDescription}>
                        <span>
                          {animatedText(
                            "The Showroom is Maison Pyramide Group’s wholesale and retail strategy, sales, and distribution platform. We support multinational brands launching new retail opportunities or expanding their distribution."
                          )}
                        </span>
                      </div>
                      <a
                  ...
                  <Col md={4}>
                    <div className={groupStyles.card}>
                      ...
                      <div className={groupStyles.groupDescription}>
                        <span>
                          {animatedText(
                            "A talent management agency representing celebrities, social media influencers, actors, and musicians. Ego & East partners global brands with the right digital talents."
                          )}
                        </span>
                      </div>
                      <a
              ...
              >
                ...
                <div className={groupStyles.office}>
                  <Row>
                    <Col
                      md={12}
                      className={`${groupStyles.office_network_img} mobile`}
                    >
                      {data?.office_mobile_image?.custom_data && (
                        <Image
                          src={data?.office_mobile_image?.custom_data?.url}
                          width={70}
                          height={100}
                          objectFit="cover"
                          unoptimized={true}
                    ...
                    <Col md={4}>
                      <div className={groupStyles.office_network}>
                        ...
                        <p>{animatedText(data?.office_text1)}</p>
                      </div>
                    </Col>
                    <Col md={4} className={`disktop_only`}>
                      {data?.office_image && (
                        <Image
                          src={data?.office_image?.custom_data?.url}
                          unoptimized={true}
                          width={70}
                          height={100}
                          layout="responsive"
                    ...
                    <Col md={4}>
                      <div
                        className={`${groupStyles.office_network} ${groupStyles.office_network_text}`}
                      >
                        <p>{animatedText(data?.office_text2)}</p>
                      </div>
                    </Col>
                  </Row>
                </div>
          ...
          <ParallaxCache/> */}
                    ...
                    <Col md={4}>
                      <div className={groupStyles.card}>
                        {data.leader1_image?.custom_data?.url && (
                          <Image
                            className={groupStyles.img}
                            src={data?.leader1_image?.custom_data?.url}
                            height={150}
                            unoptimized={true}
                            objectFit={"cover"}
                            width={100}
                    ...
                    <Col md={4}>
                      <div className={groupStyles.card}>
                        {data.leader2_image?.custom_data?.url && (
                          <Image
                            className={groupStyles.img}
                            src={data?.leader2_image?.custom_data?.url}
                            height={150}
                            objectFit={"cover"}
                            unoptimized={true}
                            width={100}
                        ...
                        <h3>Maria Munoz</h3>
                        {/* <p>Co-Founder & Partner</p> */}
                        <p className={groupStyles.desc}>{data?.leader2_text}</p>
                      </div>
                    </Col>
                    <Col md={4}>
                      <div className={groupStyles.card}>
                        {data.leader3_image?.custom_data?.url && (
                          <Image
                            className={groupStyles.img}
                            src={data?.leader3_image?.custom_data?.url}
                            height={150}
                            objectFit={"cover"}
                            unoptimized={true}
                            width={100}
                    ...
                    <Col md={4}>
                      <div className={groupStyles.card}>
                        {data.leader4_image?.custom_data?.url && (
                          <Image
                            className={groupStyles.img}
                            src={data?.leader4_image?.custom_data?.url}
                            height={150}
                            objectFit={"cover"}
                            unoptimized={true}
                            width={100}
                    ...
                    <Col md={4}>
                      <div className={groupStyles.card}>
                        {data.leader5_image?.custom_data?.url && (
                          <Image
                            className={groupStyles.imgPro}
                            src={data?.leader5_image?.custom_data?.url}
                            height={150}
                            objectFit={"cover"}
                            unoptimized={true}
                            width={100}
                    ...
                    <Col md={4}>
                      <div className={groupStyles.card}>
                        {data.leader6_image?.custom_data?.url && (
                          <Image
                            className={groupStyles.imgPro}
                            src={data?.leader6_image?.custom_data?.url}
                            height={150}
                            objectFit={"cover"}
                            unoptimized={true}
                            width={100}
              ...
              <ParallaxProvider>
                <ParallaxCache />
                <Parallax
                  translateY={[isMobile ? -20 : 10, isMobile ? -15 : -30]}
                >
                  {data?.slider && (
                    <GroupSlider
                      cultureText={data?.culture_text}
              ...
              <ParallaxProvider>
                <ParallaxCache />
                <Parallax
                  translateY={[isMobile ? -5 : 0, isMobile ? -10 : -50]}
                >
                  <ParallaxCache />
                  ...
                  <div className={groupStyles.press}>
                    ...
                    <p className="text-center">
                      {animatedText(
                        "Discover why everyone's talking about our innovative projects, our team of experts, and our mission to elevate inspiring brands."
                      )}
                    </p>
                    <Row>
                      {articles[0] &&
                          ...
                          return (
                            ...
                            >
                              <div className={groupStyles.press_card}>
                                <div className={groupStyles.img}>
                                  {item.attributes.image?.custom_data?.url && (
                                    <>
                                      ...
                                      <Image
                                        src={
                                          item.attributes?.image?.custom_data
                                            ?.url
                                        }
                                        layout="responsive"
                                        unoptimized={true}
                                ...
                                <div className={groupStyles.card_tag}>
                                  {item.attributes?.tag}
                                </div>
                              </div>
                            </Col>
